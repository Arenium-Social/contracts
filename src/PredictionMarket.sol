    ...
    Ownable
{
    ...
    AMMContract public amm; // Uniswap V4 AMM contract used to manage trading of outcome tokens.
    ...
    function initializeMarket(
        ...
        // Initialize uniswap V4 liquidity pool for trading of outcome tokens.
        amm.initializeLiquidityPool(
            address(outcome1Token),
            address(outcome2Token),0,0,0,marketId
        )
    ...
    function assertMarket(
        ...
        if (
            assertedOutcomeId != outcome1Hash &&
            assertedOutcomeId != outcome2Hash &&
